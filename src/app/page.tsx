  ...
  return (
    <div className={styles.container}>
      ...
      <SectionComponent sectionName="Обо мне">
        <p>
          Привет! Я веб-разработчик с небольшим, но ценным опытом
          коммерческой разработки. Моя страсть к программированию началась еще
          во время учебы, и теперь спустя несколько лет обучения и участия
          в чемпионатах, я изучил большое количество библиотек, фреймворков,
          подходов и других технологий. За время карьеры я участвовал в
